...
class CategoryScreen extends StatelessWidget {
  ...
  final int categoryId; // New field to store the category id
  late final Future<List<Product>?> futureData;

  CategoryScreen({Key? key, required this.categoryId}) : super(key: key) {
    futureData = ProductService.fetchCategoryBased(categoryId); // Use the categoryId in fetchCategoryBased
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "Category", // Change the title as needed
